    ...
    return (
        <>
            <Switch>
                ...
                <RouteWrapper exact={true} path="/hosted-itinerary-details" component={Hosteditinerarydetails} layout={Layouts} isPrivateRoute={true} />
                <RouteWrapper exact={true} path="/applied-host" component={AppliedHost} layout={Layouts} isPrivateRoute={true} />
                <RouteWrapper exact={true} path="/applied-Hosting-History" component={AppliedHostingHistory} layout={Layouts} isPrivateRoute={true} />
