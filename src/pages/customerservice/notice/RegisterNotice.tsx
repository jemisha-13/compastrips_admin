                        ...
                        <Form>
                            <div className="overflow-table">
                                ...
                                <Container fluid className="mt-2 mb-5 border-tabel-b1">
                                    <Row>
                                        <Col md={3} className="yellow-bg-table font-18-bold"> <span> 제목 <span className="span-color-pink"> * </span> </span>  </Col>
                                        ...
                                        <Col md={3} className="yellow-bg-table font-18-bold"><span> 내용  <span className="span-color-pink"> * </span> </span></Col>
                                        <Col md={9} className="profile-table-td-input">
                                            <div className="py-3">
                                                <InputField
                                                    name="information"
